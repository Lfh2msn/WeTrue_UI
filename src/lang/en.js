export default {
  ...
  login: {
    ...
    createMnemonic: 'Generate New Wallet',
    accountAddress: 'New Wallet Address',
    MnemonicTips: 'New Mnemonic',
    ...
    passWarning: 'Secure password requires {0} characters',
    input: 'Input',
    verify: 'Verify',
    securePassword: '{0} Secure Password',
  ...
  my: {
    ...
    infoEdit: {
      ...
      randomAvatarExpend: 'Expend {0} WTT',
      randomAvatarText: 'Randomly generate a new Avatar',
      avatarRule: 'Note: You need to activate the VIP',
      agree: 'Agree',
      channel: 'Channel Closed',
      noVip: 'VIP Not Activated',
